...
public interface IHistogram {
   ...
   *
   * @return the values for the histogram as an integer array. The first index
   *     holds the color values and the second index holds the actual value for the histogram.
   */
  int[][] getHistogram();
